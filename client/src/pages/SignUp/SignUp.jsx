...
const SignUp = () => {
    ...
    const uploadImage = async (e) => {
        ...
        try {
            // cloudName="ddwfvrsnv"
            setProgressBar(true)
            const response = await axios.post("https://api.cloudinary.com/v1_1/ddwfvrsnv/image/upload", data)
        ...
        <div className='signUp'>
            <div className="signup_card">
                ...
                <div className="signUp_Inputs">
                    ...
                    <input type="text" className="signUp_Inputs_inp" value={singUpFiled.userName} onChange={(e) => { handleInputFiled(e, "userName") }} placeholder='UserName' />
                    ...
                    <input type="text" className="signUp_Inputs_inp" value={singUpFiled.about} onChange={(e) => { handleInputFiled(e, "about") }} placeholder='About You channel' />
